...
<head>
  ...
  <link rel="stylesheet" href="<?=base_url('assets/template/login')?>/css/login.css">
</head>
<body>
    ...
    <div class="container">
      <div class="card login-card">
        <div class="row no-gutters">
          <div class="col-md-5">
            <img src="<?=base_url('assets/template/login')?>/images/login.jpg" alt="login" class="login-card-img">
          </div>
          <div class="col-md-7">
            <div class="card-body">
              <div class="brand-wrapper">
                <img src="<?=base_url('assets/template/login')?>/images/mik.png" alt="logo" class="logo">
              </div>
